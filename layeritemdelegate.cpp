...
{
    QImage gridImage(240, 200, QImage::Format_RGB32);
    ...
    m_gridPixmap = QPixmap::fromImage(QImage(":/TIM图片20180319172005.png"));
}
...
QWidget *LayerItemDelegate::createEditor(QWidget *parent, const QStyleOptionViewItem &option, const QModelIndex &index) const
{
    qDebug() << "createEditor";
...
void LayerItemDelegate::updateEditorGeometry(QWidget *editor, const QStyleOptionViewItem &option, const QModelIndex & index ) const
{
